...
const Guide = () => {
  ...
  return (
    ...
    >
      ...
      <p>1. Choose who goes first: X or O. It's like getting a Dundies award.</p>
      <p>2. Take turns clicking on the boxes to place your mark. Pretend you're Joey strategizing his next date.</p>
      <p>3. Connect three marks—horizontally, vertically, or diagonally—to win!</p>
<p>4. <span>Warning:</span> You can only make three moves at once. Attempt a fourth, and your oldest move disappears like Voldemort's nose after Harry's second year at Hogwarts.</p>
