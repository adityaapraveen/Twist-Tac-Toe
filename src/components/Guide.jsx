...
const Guide = () => {
  ...
  return (
    ...
    >
      ...
      <p>1. Choose who goes first: <span className='xPlayer'>X</span> or <span className='oPlayer'>O</span>. </p>
      ...
      <p>4. <span className='warning'>Warning:</span> At a time only three moves are possible on the board. Attempt a fourth, and your oldest move disappears like Voldemort's nose after Harry's second year at Hogwarts.</p>
    </motion.div>
  );
};
